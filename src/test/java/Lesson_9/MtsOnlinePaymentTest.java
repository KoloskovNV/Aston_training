...
public class MtsOnlinePaymentTest {
    ...
    public void testMoreInfoLink() {
        ...
        paymentPage.verifyPaymentCardTitle();
    ...
    public void testFormSubmission() {
        ...
        paymentPage.verifyPhoneNumberInModal();
        System.out.println("Тест 4 пройден: формы заполнены, переход в следующее меню осуществлён, телефон проверен");
    }
}